...
func (dr *DeliveryRepository) CreateDelivery(ctx context.Context, req *delivery.CreateDeliverRequest) (*delivery.DeliverResponse, error) {
...
func (dr *DeliveryRepository) GetDeliveryById(ctx context.Context, id int64) (*delivery.DeliverResponse, error) {
	query := `
		SELECT 
...
func (dr *DeliveryRepository) getDishItems(ctx context.Context, deliveryId int64) ([]*delivery.DishDeliveryItem, error) {
	query := `
...
func (dr *DeliveryRepository) GetDeliveryByClientName(ctx context.Context, clientName string) (*delivery.DeliveryDetailedListResponse, error) {
    ...
    return response, nil
		...
		func (dr *DeliveryRepository) DeleteDeliveryById(ctx context.Context, id int64) error {
