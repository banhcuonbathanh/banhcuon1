...
type SetProto struct {
	ID          int32           `json:"id"` // Changed from int64 to int32 as per proto
	Name        string          `json:"name"`
	Description string          `json:"description"`
...
// asl;dkfadfjsh;laksdjfl;kajsdl;fjasldjfl;asdjfl
// type OrderType struct {
// 	ID             int64          `json:"id"`
// 	GuestID        int64         `json:"guest_id"`
// 	UserID         int64         `json:"user_id"`
...
// 	ID int64 `json:"id"`
// }
// ----a;lkskdjf;lkasjdl;fjasl;djfl;asdjfl;ajsdl;fjal;sdjfl;asdflaksjd
...
// -;akisdjiadijs;hf;lkasdf;lkasd;ljf;alsdjf;laksdjfl;asjd;lfjal;sdjfl;asadfjls
