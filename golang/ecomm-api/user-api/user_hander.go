...
type HandlercontrollerUser struct {
	ctx        context.Context
	client     pb.EcommUserClient 
	TokenMaker *token.JWTMaker
}

func NewHandlerUser(client pb.EcommUserClient, secretKey string) *HandlercontrollerUser {
	return &HandlercontrollerUser{
...
func (h *HandlercontrollerUser) FindByEmailtest(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlercontrollerUser) ListUserstest(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlercontrollerUser) DeleteUsertest(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlercontrollerUser) Logintest(w http.ResponseWriter, r *http.Request) {
	log.Println("User Logintest Logintest Logintest handlercontroller")
...
func (h *HandlercontrollerUser) LogoutUsetest(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlercontrollerUser) RenewAccessTokentest(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlercontrollerUser) RevokeSessiontest(w http.ResponseWriter, r *http.Request) {
	claims := r.Context().Value(middleware.AuthKey{}).(*token.UserClaims)
