...
import { DishListResType, DishResType, CreateDishBodyType, UpdateDishBodyType } from './dish.schema';
...
export class DishController {
  ...
  async updateDish(id: number, body: UpdateDishBodyType): Promise<DishResType['data']> {
    try {
