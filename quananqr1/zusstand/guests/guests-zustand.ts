...
import { GuestCreateOrdersBodyType, GuestCreateOrdersResType, GuestGetOrdersResType, GuestLoginBodyType, GuestLoginResType } from "./guest.schema";
import { Dish, DishListResType } from "../dished/domain/dish.schema";
